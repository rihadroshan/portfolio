      ...
      <div className="relative z-10 min-h-screen backdrop-contrast-110 backdrop-brightness-95">
        ...
        <section className="relative min-h-screen flex items-center overflow-hidden">
          ...
          >
            ...
            >
              Building defensive systems and simulating attacks to combat evolving cyber threats.
            </motion.p>
          </motion.div>
        </section>
        ...
        <footer className="border-t border-gray-800/20">
          <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="text-sm text-gray-500">
              © {new Date().getFullYear()} Rihad Roshan. All rights reserved.
            </div>
          </div>
        </footer>
      </div>
